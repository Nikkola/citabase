...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Пожалуйста, введите тоже самое значение снова.",
		maxlength: $.validator.format("Пожалуйста, введите не больше {0} символов."),
		minlength: $.validator.format("Пожалуйста, введите не меньше {0} символов."),
		rangelength: $.validator.format("Пожалуйста, введите значение длиной между {0} и {1} ."),
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				label = $("<" + this.settings.errorElement + "/>")
					...
					.addClass(this.settings.errorClass).addClass('control-label')
					.html(message || "");
				if ( this.settings.wrapper ) {
