...
Route::post('/forget', 'users@forget');

//изменение старого пароля на новый, если пользователь забыл
Route::post('/recovery', 'users@recovery');


//QUOTES
//запись цитаты пользователя в БД
Route::post('/quotes/(:num)', 'quotes@store');

//выборка АБСОЛЮТНО всех цитат из БД
Route::get('/quotes', 'quotes@index' );

//выборка всех цитат пользователя из БД
Route::get('/quotes/(:num)', 'quotes@show' );

//изменение цитаты пользователя в БД
Route::put('/quotes/(:num)/(:num)', 'quotes@update');

//удаление цитаты пользователя из БД
Route::delete('/quotes/(:num)/(:num)', 'quotes@destroy');
